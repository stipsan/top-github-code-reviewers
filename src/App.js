        ...
        <p className="App-intro">
          ...
          <g fill="none" fillRule="evenodd">
            {topReviewers.map((reviewer, i) => {
              return <g key={reviewer.author.login}>
              <path d={`M 0 ${i * 64}`} d="M1.5 163.5h639.003" stroke="#EAECEF" stroke-linecap="square"/>
              <text fontSize="22" fill="#FFF">
                <tspan x="20" y="120">{reviewer.author.login}</tspan>
              </text>
            </g>})}
            <rect fill="url(#b)" x="79" y="97" width="51" height="47" rx="8"/>
            <path d="M1.5 163.5h639.003" stroke="#EAECEF" strokeLinecap="square"/>
            <text fontSize="22" fill="#FFF">
              <tspan x="20" y="120">🥇</tspan>
            </text>
            <text fontSize="22" fill="#000">
              <tspan x="13" y="223">🥈</tspan>
            </text>
            <text fontSize="22" fill="#000">
              <tspan x="13" y="308">🥉</tspan>
            </text>
            <text font-family="Helvetica" font-size="22" letter-spacing=".81" fill="#586069">
              <tspan x="147" y="120">Winner</tspan>
            </text>
            <text font-family="Helvetica" font-size="22" letter-spacing=".81" fill="#586069">
              <tspan x="554" y="126">10</tspan>
            </text>
            <text font-family="Helvetica" font-size="22" letter-spacing=".81" fill="#586069">
              <tspan x="38" y="37">Top Code Reviewers</tspan>
            </text>
            <text font-family="Helvetica" font-size="22" letter-spacing=".81" fill="#586069">
              <tspan x="536" y="26">Score</tspan>
            </text>
          </g>
        </svg>
        </p>
